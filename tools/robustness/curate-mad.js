 ...
 *
 * Usage: node tools/robustness/curate-mad.js --src /path/to/mad-raw.jsonl --n 200
 *
...
import { dotToLogicCore } from '../../src/bpmn/dot.js';
...
if (!src) {
  console.error('Usage: node tools/robustness/curate-mad.js --src PATH --n 200');
  console.error('');
